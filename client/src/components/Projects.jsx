...
const Projects = () => {
  return (
    <div className="relative min-w-[550px] w-full flex bg-raisin" id="projects">
      <div className="w-full min-h-screen flex flex-col justify-around animate-slideup">
        <div className="relative w-[150px] h-[150px] flex justify-center items-center section-container my-[65px]">
          <img
            src={asteroid}
            alt="my project"
        ...
        <div className="h-fit flex flex-wrap justify-center items-start my-[50px] gap-8 select-none">
          {projects.map((el) => (
            <div
              key={el.name}
